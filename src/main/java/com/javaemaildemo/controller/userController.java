...
public class userController {
    ...
    /* emailService必须是对象的成员变量，否则EmailService类中通过注解注入值的方式将失效 */
    @Autowired
    ...
    @ResponseBody
    public boolean sendEmail(@RequestParam("file") MultipartFile[] file, String to, String subject,
            String contentText) {
        if (file.length > 0) {
            ...
            for (int i = 0; file.length > i; i++) {
                ...
                String path = "C:\\Users\\Administrator\\Desktop\\javaemaildemo-master\\src\\main\\resources\\static\\file\\";
